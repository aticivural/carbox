...
public class Advertise implements Serializable {
	...
	private static final long serialVersionUID = 2042067359832517279L;
	...
	public Advertise(int userId, String vehicleType, String brand, String model, String motor, String hardwarePackage,
	...
	public Advertise(int userId, String vehicleType, String brand, String model, String motor, String hardwarePackage,
					String homePhone, String mobilePhone, String year, String fuel, String gear, String km, String color,
					String advertisingHeader, String advertisingDetail, 
					Date startingDate, Date finishingDate,Double startingPrice) {
		super();
		this.userId = userId;
		this.vehicleType = vehicleType;
		this.brand = brand;
